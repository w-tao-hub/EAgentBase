...
class ErrorCode(str, Enum):
    ...
    # 多主代理路由相关错误码
    UNKNOWN_MASTER_AGENT = "UNKNOWN_MASTER_AGENT"
    MASTER_AGENT_SESSION_MISMATCH = "MASTER_AGENT_SESSION_MISMATCH"
    INVALID_MASTER_AGENT_CONFIG = "INVALID_MASTER_AGENT_CONFIG"
    SUBAGENT_NOT_MOUNTED = "SUBAGENT_NOT_MOUNTED"
